...
class MaliciousAppClassificator(val context: Context) {
    var model: AppsModel? = null
    var buffer: TensorBuffer? = null
    ...
    fun encodePermissions(permissions: Array<String>): FloatArray {
    ...
    fun predict(permissions: Array<String>, minConfidence: Float = 0.5f): Boolean {
